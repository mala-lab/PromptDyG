...
from networks.act import act_dict

from networks.layer.generalconv import (GeneralConvLayer,
                            GeneralEdgeConvLayer)

from networks.layer.residual_edge_conv import ResidualEdgeConv
from networks.layer.drcnn import DCRNN
from networks.layer.evolve_gcn_h import EvolveGCNH
from networks.layer.evolve_gcn_o import EvolveGCNO
from networks.layer.gconv_gru import GConvGRULayer
from networks.layer.gconv_lstm_baseline import GConvLSTMBaseline
from networks.layer.gconv_lstm import GConvLSTM
from networks.layer.tgcn import TGCN
from networks.layer.edgeconv_gru import GeneralEdgeConvGRU
...
layer_dict = {
    ...
    'gconv_lstm_baseline': GConvLSTMBaseline,
    'gconv_lstm': GConvLSTM,
    'edge_conv_gru': GeneralEdgeConvGRU,
}
